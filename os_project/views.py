    ...
    def get_context_data(self, **kwargs):
        ...
        if self.request.user.is_authenticated:
            try:
                ...
                # Fallback to legacy check
                context["is_owner"] = self.object.old_owner_id == self.request.user.id

        return context


# Create, Update, Delete views - Adding OSMaintainerRequiredMixin
...
# Dashboard views for project owners - Now all protected with OSMaintainerRequired
@login_required
